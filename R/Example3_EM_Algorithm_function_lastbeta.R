...
Example3_EM_Algorithm_function_lastbeta = function(Y_T,K,N,m,threshold = 0.5,max = 500,R = 15, Crit = "LV", all.plot = FALSE){
  T = length(Y_T)
  ...
  for(r in 1:R){
    ...
    while(counter <= max){
      ...
      alpha_Sammler[[counter+1]] = Example3_alpha_next_function(alpha_Sammler[[counter]],P_Sammler[[counter]],Y_T,N,K)
